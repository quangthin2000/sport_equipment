<%@ Page Title="Đăng nhập" Language="C#" MasterPageFile="../Index_Homepage.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="WebShop.Login" %>
<!DOCTYPE html>
    ...
    <div class="FormDangNhap">
        ...
        <div class="controls">
            ...
            <div class="row">
                <div class="left">&nbsp;</div>
                <div class="right">
<%--                    <asp:LinkButton ID="lbtDangNhap" runat="server" CssClass="btDangNhap" OnClick="lbtDangNhap_Click">LinkButton</asp:LinkButton>--%>
                </div>            
            </div>
            <div>
