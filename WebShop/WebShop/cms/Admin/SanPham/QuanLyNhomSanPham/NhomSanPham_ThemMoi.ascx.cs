...
{
    public partial class Nhom_ThemMoi : System.Web.UI.UserControl
    {
        ...
        private void HienThiThongTin(string id)
        {
            if (thaotac == "ChinhSua")
            {
                ...
                dt = WebShop.NhomSanPham.Thongtin_Nhomsp_by_id(id);
                if (dt.Rows.Count > 0)
                {
        ...
        protected void btThemMoi_Click(object sender, EventArgs e)
        {
            if (thaotac == "ThemMoi")
            {
                ...
                WebShop.NhomSanPham.Nhomsanpham_Inser(tbTenNhomSP.Text, flAnhDaiDien.FileName, tbThuTu.Text, tbSoSanPhamHienThi.Text, "");
                ltrThongBao.Text = "<div class='thongBaoTaoThanhCong' style='color:#1D3C5A;font-size:16px;padding-bottom:20px;text-align:center;font-weight:bold'>Đã tạo danh mục: " + tbTenNhomSP.Text + "</div>";
            ...
            else
            {
                ...
                WebShop.NhomSanPham.Nhomsanpham_Update(id, tbTenNhomSP.Text, tenAnhDaiDien, tbThuTu.Text, tbSoSanPhamHienThi.Text);
