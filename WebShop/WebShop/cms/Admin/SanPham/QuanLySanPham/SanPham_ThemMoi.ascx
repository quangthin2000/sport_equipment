<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SanPham_ThemMoi.ascx.cs" Inherits="WebShop.cms.Admin.SanPham.QuanLySanPham.SanPham_ThemMoi" %>
<%@ Register Assembly="CKEditor.NET" Namespace="CKEditor.NET" TagPrefix="CKEditor" %>
<div class="head">
    Thêm mới, chỉnh sửa danh sách sản phẩm
</div>
<div class="FormThemMoi">
    ...
    <div class="thongTin">
        ...
        <div class="oNhap">
            <asp:TextBox ID="tbNgayTao" runat="server"></asp:TextBox></div>
    </div>
    <div class="thongTin">
        <div class="tenTruong">Ngày hủy</div>
        <div class="oNhap">
            <asp:TextBox ID="tbNgayHuy" runat="server"></asp:TextBox></div>
    </div>
    <div class="thongTin">
