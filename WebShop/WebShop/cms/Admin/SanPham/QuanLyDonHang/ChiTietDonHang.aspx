<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChiTietDonHang.aspx.cs" Inherits="WebShop.cms.Admin.SanPham.QuanLyDonHang.ChiTietDonHang" %>
        ...
        <div class="thongTinSanPham">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td class="tar"><b>
                        <asp:Literal ID="ltrTongTienDonHang" runat="server"></asp:Literal></b></td>
                </tr>
            </table>
        </div>
        <div class="thongTinCuoi">
            Mọi nhu cầu liên hệ của quý khách, vui lòng liên hệ với chúng tôi theo thông tin dưới đây.<br/>
            Cửa hàng thời trang vật dụng thể thao MNST<br/>
            Địa chỉ: 03 Quang Trung, Hải Châu, Đà Nẵng<br/>
            Số điện thoại: 0905 480 650<br/>
            Email: MNSTSport@gmail.com<br/>
