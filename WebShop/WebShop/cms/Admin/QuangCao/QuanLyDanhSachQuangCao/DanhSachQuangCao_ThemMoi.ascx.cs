    ...
    public partial class DanhSachQuangCao_ThemMoi : System.Web.UI.UserControl
    {
        ...
        private void HienThiThongTin(string id)
        {
            if (thaotac == "ChinhSua")
            {
                ...
                dt = WebShop.QuangCao.Thongtin_Quangcao_by_id(id);
                if (dt.Rows.Count > 0)
                {
        ...
        {
            DataTable dt = new DataTable();
            dt = WebShop.NhomQuangCao.Thongtin_Nhomquangcao();
        ...
        protected void btThemMoi_Click(object sender, EventArgs e)
        {
            if (thaotac == "ThemMoi")
            {
                ...
                WebShop.QuangCao.Quangcao_Inser(
            ...
            else
            {
                ...
                WebShop.QuangCao.Quangcao_Update(
