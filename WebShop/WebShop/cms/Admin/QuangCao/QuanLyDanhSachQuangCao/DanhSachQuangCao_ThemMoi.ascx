<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DanhSachQuangCao_ThemMoi.ascx.cs" Inherits="WebShop.cms.Admin.QuangCao.QuanLyDanhSachQuangCao.DanhSachQuangCao_ThemMoi" %>
<div class="head">
