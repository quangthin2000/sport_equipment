...
namespace WebShop.cms.Admin.QuangCao.QuanLyDanhSachQuangCao.Ajax
{
    public partial class DanhSachQuangCao : System.Web.UI.Page
    {
        string thaotac = "";
        ...
        private void XoaQuangCao()
        {
            ...
            if (Request.Params["QuangCaoID"] != null)
            {
                ...
                WebShop.QuangCao.Quangcao_Delete(QuangCaoID);
