<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DanhSachQuangCao_HienThi.ascx.cs" Inherits="WebShop.cms.Admin.QuangCao.QuanLyDanhSachQuangCao.DanhSachQuangCao_HienThi" %>
<div class="head">
