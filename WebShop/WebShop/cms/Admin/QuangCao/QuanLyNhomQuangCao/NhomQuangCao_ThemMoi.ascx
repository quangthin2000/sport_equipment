<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="NhomQuangCao_ThemMoi.ascx.cs" Inherits="WebShop.cms.Admin.QuangCao.QuanLyNhomQuangCao.NhomQuangCao_ThemMoi" %>
<div class="head">
