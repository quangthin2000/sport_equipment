<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="NhomQuangCao_HienThi.ascx.cs" Inherits="WebShop.cms.Admin.QuangCao.QuanLyNhomQuangCao.NhomQuangCao_HienThi" %>
<div class="head">
