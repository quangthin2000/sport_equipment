    ...
    public partial class Menu_ThemMoi : System.Web.UI.UserControl
    {
        ...
        private void HienThiThongTin(string id)
        {
            if (thaotac == "ChinhSua")
            {
                ...
                dt = WebShop.Menu.Thongtin_Menu_by_id(id);
                if (dt.Rows.Count > 0)
                {
        ...
        {
            DataTable dt = new DataTable();
            dt = WebShop.Menu.Thongtin_Menu_by_MaMenuCha("0");
        ...
        {
            DataTable dt = new DataTable();
            dt = WebShop.Menu.Thongtin_Menu_by_MaMenuCha(MaMenuCha);
        ...
        protected void btThemMoi_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                WebShop.Menu.Menu_Update(id, tbTenMenu.Text, tbLienKet.Text,
                    ddlMenuCha.SelectedValue, tbThuTu.Text);
