<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Menu_ThemMoi.ascx.cs" Inherits="WebShop.cms.Admin.Menu.Menu_ThemMoi" %>
<div class="head">
...
<div class="FormThemMoi">
    ...
    <div class="thongTin">
        ...
        <div class="oNhap">
            <asp:TextBox ID="tbLienKet" runat="server"></asp:TextBox></div>
    </div>
    <div class="thongTin">
    ...
    <div class="thongTin">
        ...
        <div class="oNhap"><asp:CheckBox ID="cbThemNhieuDanhMuc" runat="server" Text="Tạo thêm mục khác sau khi tạo mục này"/></div>
    </div>
    <div class="thongTin">
        <div class="tenTruong">&nbsp;</div>
        <div class="oNhap">
